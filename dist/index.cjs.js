...
class AudioDeviceMonitor extends node_events.EventEmitter {
    constructor(options) {
        super();
    ...
    start() {
        this.audioDeviceProcess = node_child_process.spawn(this.exePath, [this.delay.toString(), this.stepVolume.toString()]);
...
module.exports = AudioDeviceMonitor;
